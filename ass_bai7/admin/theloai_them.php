...
<body>
<form action="/ex_starts/bai7/admin/theloai_them_xl.php" method="post" enctype="multipart/form-data" name="form1">
    <table align="left" width="400">
        ...
        <tr>
            <td align="right"><input type="submit" name="Them" value="Them" /></td>
